...
import { PhotoIcon, BellIcon, EllipsisHorizontalIcon, CheckCircleIcon, EnvelopeOpenIcon, EnvelopeIcon } from '@heroicons/react/24/outline';
    ...
    const data = [
        {
            ...
            time: '1h',
            is_read: 1,
            icon: <PhotoIcon className='w-5 text-gray-500 dark:text-gray-400' />
        },
        {
            user: 'John Doe',
        ...
        },
        {
            ...
            time: '1w',
            is_read: 1,
            icon: <BellIcon className='w-5 text-gray-500 dark:text-gray-400'/>
        },
        {
            user: 'George Hill',
        ...
        <>
            {isMobile === false ?
                    ...
                    <Menu.Button className='flex items-center rounded-md group p-2'>
                        ...
                        <BellIcon className='w-5 text-gray-700 dark:text-gray-400'/>
                    </Menu.Button>
                    <Transition
                    ...
                    >
                        <Menu.Items className='absolute rounded-lg w-[500px] border md:right-0 z-[100] bg-white dark:bg-gray-950 dark:border-gray-900'>
                            <div className='flex justify-between items-center gap-2 p-4 border-b dark:border-gray-900'>
                                ...
                                <EllipsisHorizontalIcon className='w-7 text-gray-500 dark:text-gray-200'/>
                            </div>
                            <div className='p-4'>
                                <div className='flex flex-col gap-2 items-start h-60 overflow-y-auto'>
                                    {data.map((data, i) => (
                                        <div className='flex items-center justify-between w-full p-4 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-900 ' key={i}>
                                            ...
                                            {data.is_read == 1 ? <EnvelopeOpenIcon className='w-5 text-gray-500 dark:text-gray-400'/> : <EnvelopeIcon className='w-5 text-gray-500 dark:text-gray-400'/>}
                                        </div>
                                    ))}
                                </div>
                            </div>
                    ...
                    <div ref={notificationRef}>
                        ...
                        <div className={`${isOpen ?'translate-x-0 opacity-100' : 'translate-x-full'} fixed top-0 right-0 z-50 w-[300px] h-full transition-all duration-300 transform border-l bg-white dark:bg-gray-950 dark:border-gray-900`}>
                            <div className='flex justify-between items-center gap-2 p-4 border-b mt-2 dark:border-gray-900 '>
                                ...
                                <EllipsisHorizontalIcon className='w-7 text-gray-700 dark:text-gray-200'/>
                            </div>
                            <div className='p-4'>
