    ...
    public function report_data(Request $request)
    {
        ...
        $reportData = $data->map(function ($item) use ($date) {
            return [
                ...
                'product_price' => $item->product->activePurchasePrice->price,
                'product_price_sale' => $item->product->activeSalePrice->price,
    ...
    public function movement_data(Request $request)
    {
        ...
        $reportData = $data->map(function ($item) use ($date) {
            return [
                ...
                'product_price' => $item->activePurchasePrice->price,
                'product_price_sale' => $item->activeSalePrice->price,
                'unit' => $item->unit,
                'weight' => $item->weight,
